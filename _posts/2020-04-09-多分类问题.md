...
### 常用方法:OvO以及OvR.
![principle](../img/0419/principle.png)
...
![raw_data_preview](../img/0419/raw_data_preview.png)
...
![LR_multi](../img/0419/LR_multi.png)
![SVM_multi](../img/0419/SVM_multi.png)

### 多分类问题也可以通过Sci-kit Learn模块中已封装好OneVsOneClassifier和OneVsRestClassifier的方法实现. 
![sklearn_ovo](../img/0419/sklearn_ovo.png)
![sklearn_ovr](../img/0419/sklearn_ovr.png)
